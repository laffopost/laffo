...
const QUIZZES = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Ethereum", "Ethanol", "Ethernet", "Ether"],
        correct: 0,
      },
      {
        q: "What is the maximum supply of Bitcoin?",
        options: ["10M", "21M", "50M", "Unlimited"],
        correct: 1,
      },
      {
      ...
      {
        q: "Who created Bitcoin under the pseudonym Satoshi Nakamoto?",
        options: [
          "Unknown",
          "Vitalik Buterin",
          "Charles Hoskinson",
      ...
      {
        q: "Which cryptocurrency uses Proof of Work?",
        options: ["Bitcoin", "Ripple", "Cardano", "Polkadot"],
        correct: 0,
      },
      {
      ...
      {
        q: "What year was Ethereum created?",
        options: ["2013", "2014", "2015", "2016"],
        correct: 2,
      },
      {
        q: "What does HODL mean to crypto investors?",
        options: [
          "Sell immediately",
          "Hold long-term despite volatility",
      ...
      {
        q: "Which layer-1 blockchain has the fastest transaction speed?",
        options: ["Bitcoin", "Solana", "Ethereum", "Ripple"],
        correct: 1,
      },
      {
        ...
        options: [
          "A eating utensil",
          "A protocol change that splits the chain",
          "A mining tool",
          "A wallet feature",
        ],
        correct: 1,
      },
      {
        ...
        options: [
          ...
          "Locking coins to validate network",
          "Buying call options",
          "Selling short",
        ],
        correct: 1,
      ...
      },
      {
        ...
        options: [
          "Fear Of Missing Out",
          "Follow Or Miss Opportunities",
          "Fundamental Option Market Open",
          "For Official Market Operations",
        ],
        correct: 0,
      },
      {
        q: "Which exchange is the largest crypto trading platform?",
        options: ["Kraken", "Coinbase", "Binance", "Gemini"],
        correct: 2,
      },
      {
        q: "What is a wallet in crypto?",
        options: [
          "A physical purse",
      ...
      {
        q: "What is the most valuable cryptocurrency by market cap?",
        options: ["Ethereum", "Bitcoin", "BNB", "XRP"],
        correct: 1,
      },
      {
        q: "What does AltCoin mean?",
        options: [
          "Alternative coins (non-Bitcoin)",
          "High-risk coins",
    ...
    questions: [
      {
        ...
        options: [
          ...
          "Hold Or Die Laughing",
          "Honest Obligation to Deliver",
          "Hold On Digital Ledger",
        ],
        correct: 0,
      },
      {
        q: 'What is the "To The Moon" meme about?',
        options: [
          "Space exploration",
      ...
      },
      {
        ...
        options: [
          "Actual diamonds",
          "Holding investments despite losses",
          "A jewelry brand",
          "A medical condition",
        ],
        correct: 1,
      },
      {
        ...
        options: [
          "A carpet removal",
          "A scam where creators abandon a project",
          "A type of exercise",
          "A cleaning service",
        ],
        correct: 1,
      },
      {
        ...
        options: [
          ...
          "When Am I Getting Money",
          "What About Global Markets",
          "Will Anything Go Massively Insane",
        ],
        correct: 0,
      },
      {
        q: "What does LAMBO mean in crypto?",
        options: [
          "A programming language",
          "Lamborghini (dream car from profits)",
          "A trading strategy",
          "A type of coin",
        ],
        correct: 1,
      ...
      {
        q: "What is a 'bagholder'?",
        options: [
          "Someone holding a bag",
          "Someone stuck with worthless coins",
          "A trader",
          "A bank teller",
        ],
        correct: 1,
      ...
      },
      {
        ...
        options: [
          "A type of coin",
          "Fear, Uncertainty, Doubt (negative sentiment)",
          "Future Use Date",
          "Fund Understanding Document",
        ],
        correct: 1,
      },
      {
      ...
      {
        q: 'What is the "paper hands" meme?',
        options: [
          "Having wet hands",
          "Selling during downturns from panic",
          "A medical condition",
          "A type of printer",
        ],
        correct: 1,
      ...
      {
        q: "What does GBTC stand for?",
        options: [
          "Global Bitcoin Trust",
          "Grayscale Bitcoin Trust",
          "Gold Backed Token Currency",
          "Government Bitcoin Trading Commission",
        ],
        correct: 1,
      },
      {
        ...
        options: [
          ...
          "Someone holding massive amounts of crypto",
      ...
      },
      {
        ...
        options: [
          "A positive outcome",
          "Destroyed/losing money (from 'wrecked')",
          "A blockchain",
          "A type of wallet",
        ],
        correct: 1,
      },
      {
        ...
        options: [
          "A type of exercise",
          "Artificially inflating then selling price",
          "A sports activity",
          "A water system",
        ],
        correct: 1,
      ...
      {
        q: "What does 'moon' as a verb mean in crypto?",
        options: [
      ...
      },
      {
        ...
        options: [
          "A type of coin",
          "Someone promoting a project for profit",
          "A trading strategy",
      ...
      {
        q: "What does 'DAPP' stand for?",
        options: [
          "Digital Application",
          "Decentralized Application",
          "Distributed Authentication Protocol",
          "Direct Automated Processing Platform",
        ],
        correct: 1,
      },
      {
        q: "What is a 'wick' in candlestick charts?",
        options: [
          "Candle material",
          "The thin lines extending from candles",
          "A trading indicator",
          "A time period",
        ],
        correct: 1,
      ...
      {
        q: "What does 'NGMI' mean?",
        options: [
          "Never Gonna Make It",
          "New Generation Market Index",
          "Next Generation Mining Interface",
          "Non-Governmental Market Initiative",
        ],
        correct: 0,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["K2", "Kangchenjunga", "Mount Everest", "Denali"],
        correct: 2,
      },
      {
      ...
      {
        q: "Which country has the most populous city?",
        options: ["China", "India", "Japan", "USA"],
        correct: 0,
      },
      {
        q: "What is the smallest US state by area?",
        options: ["Delaware", "Rhode Island", "Connecticut", "Vermont"],
        correct: 1,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "What year was the first web browser created?",
      ...
      },
      {
        ...
        options: [
          ...
          "Code available for free modification",
      ...
      },
      {
        ...
        options: [
          "Teaching humans with machines",
          "Machines learning from data",
          "Industrial learning process",
      ...
      },
      {
        ...
        options: [
          "Using actual clouds",
          "Computing done on remote servers",
          "Weather forecasting",
          "Storage in the sky",
        ],
        correct: 1,
      ...
      {
        q: "What is a framework in software development?",
        options: [
          "Metal structure",
          "Pre-built code for building apps",
          "A type of computer",
          "A programming language",
        ],
        correct: 1,
      ...
      {
        q: "What year was Linux created?",
        options: ["1989", "1991", "1993", "1995"],
        correct: 1,
      },
      {
        q: "What does MVP stand for in development?",
        options: [
...
export default function QuizGame() {
  ...
  // Get shuffled questions based on selected count
  const quizQuestions = useMemo(() => {
    if (!selectedQuiz) return [];
    const all = selectedQuiz.questions;
  ...
  const completeQuiz = async () => {
    ...
    if (firebaseUser && !firebaseUser.isAnonymous) {
      try {
        await saveGameScore(
          `quiz_${selectedQuiz.id}_${questionCount}`,
          score,
          firebaseUser.uid,
        );
      ...
      <div className="quiz-game">
        ...
        <div className="question-count-selection">
          ...
          >
            ...
            <div className="count-label">Quick Quiz</div>
            <div className="count-time">~2 min</div>
          </button>
          <button
            className="count-btn"
          ...
          >
            ...
            <div className="count-label">Standard Quiz</div>
            <div className="count-time">~5 min</div>
          </button>
          <button
            className="count-btn"
            onClick={() => handleQuestionCountSelect(20)}
          >
            <div className="count-number">20</div>
            <div className="count-label">Ultimate Challenge</div>
            <div className="count-time">~10 min</div>
          </button>
        </div>
      </div>
    );
  ...
  if (state === "quizSelect") {
    return (
      <div className="quiz-game">
        <h2>🧩 Quiz Games</h2>
        <p>Choose a quiz ({questionCount} questions)</p>
        ...
        <div className="quiz-list">
          {QUIZZES.map((quiz) => (
            ...
            >
              ...
              <div className="quiz-card-count">
                {questionCount} questions (random selection)
              </div>
            </button>
          ))}
        </div>
        ...
        <button
          ...
          onClick={() => setState("questionCount")}
        >
          ← Back
        </button>
      </div>
    ...
    return (
      <div className="quiz-game">
        ...
        <div className="quiz-question-container">
          ...
          {answered && (
            <button
              className="quiz-btn quiz-next-btn"
  ...
  if (state === "complete") {
    ...
    return (
      <div className="quiz-game">
        ...
        <button className="quiz-btn" onClick={resetGame}>
          Try Another Quiz
        </button>
      </div>
    );
